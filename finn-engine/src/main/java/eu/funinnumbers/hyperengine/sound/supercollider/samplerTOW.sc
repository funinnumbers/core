...
loungeFilenamesBufferArray = [ "lounge/1.wav", "lounge/2.wav", "lounge/3.wav", "lounge/4.wav", "lounge/5.wav", "lounge/6.wav" , "lounge/7.wav" , "lounge/8.wav", "lounge/9.wav", "lounge/10.wav", "lounge/11.wav" ];
...
r = Routine.new({
	...
	while( { timeThatHasPassedBetweenTracks < 130 }, {
