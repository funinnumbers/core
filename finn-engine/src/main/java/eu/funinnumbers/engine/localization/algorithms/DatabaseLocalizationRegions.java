...
/**
 * DatabaseLocalization Algorithm using DatabaseLocalization for regions and points localization.
 */
public class DatabaseLocalizationRegions implements Localization {
    ...
    public Point getCoordinates(final String macAddress) {
        ...
        final Point currentRegion = dbRegion.getCoordinates(currentNDPoint);

        return dbPoints.getCoordinates(currentNDPoint, regionPointsMap.get(currentRegion.getId()));
    }
