...
/**
 * Localization Algorithm using KNN and DatabaseLocalization for regions and DatabaseLocalization for points.
 */
public class AverageDatabaseRegions implements Localization {
    ...
    public Point getCoordinates(final String macAddress) {
        ...
        return dbPoints.getCoordinates(currentNDPoint, regionPointsMap.get(averageRegionID));
    }
