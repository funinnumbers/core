...
/**
 * Localization Algorithm using KNN for regions and points localization.
 */
public class KNNLocalizationRegions implements Localization {

    /**
     * KNN Localization Algorithm for regions.
     */
    private final KNNLocalization knnRegion = new KNNLocalization();

    /**
     * KNN Localization Algorithm for points in a specific region.
     */
     ...
     */
    private HashMap<Integer, Vector<Integer>> regionPointsMap = new HashMap<Integer, Vector<Integer>>(); //NOPMD
    ...
    public Point getCoordinates(final String macAddress) {
        ...
        final NDPoint currentNDPoint = knnRegion.getCurrentNDpoint(macAddress);
        ...
        final Point currentRegion = knnRegion.getCoordinates(currentNDPoint);

        return knnPoints.getCoordinates(currentNDPoint, regionPointsMap.get(currentRegion.getId()));
    }
